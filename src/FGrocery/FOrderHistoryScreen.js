  ...
  return(
    ...
    //    navigation.navigate("FProductDetailScreen")
          ...
          <View style={{width:'95%',height:210,marginEnd:10,marginBottom:15,backgroundColor:Colors.white,borderRadius:10,elevation:1,alignSelf:'center'}}>
            ...
            <Text style={{padding:3,fontSize:12,color:Colors.textcolor,fontFamily:'urbanistregular'}}>ORDER ID - 1234454544</Text>            
            <Text style={{padding:3,fontSize:12,color:Colors.textcolor,fontFamily:'urbanistregular',marginEnd:10}}>22 SEP 2014, 5:00 PM</Text>            

            </View>
            <View style={{flexDirection:'row',alignItems:'center'}}>
            <Text style={{padding:3,fontSize:14,color:Colors.textcolor,fontFamily:'urbanistbold'}}>Product Out For Delivery</Text>            
             <Text style={{backgroundColor:Colors.light_purple,padding:4,borderRadius:8,color:Colors.black,fontFamily:'urbanistmedium',marginStart:10}}>Track Here</Text>
            </View>

          

             <View style={{alignSelf:'center',width:'98%',marginTop:'3%',marginStart:'2%',flexDirection:'row',alignItems:'center',justifyContent:'space-between',backgroundColor:Colors.white,borderColor:Colors.red,borderWidth:1}}>
           
          
            <Text numColumns={2} style={{color:Colors.red,fontFamily:'urbanistbold',fontSize:13,textAlign:'center',color:Colors.red,padding:8,width:'100%'}}>CANCEL ORDER</Text>
    ...
    return <GestureHandlerRootView style={style.container}>
        ...
        <View style={{height:'7%' ,backgroundColor:Colors.light_green}}>
          ...
          <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
            ...
            <Text numberOfLines={1} style={{marginStart:'2%',marginTop:'3%',fontFamily:'urbanistmedium',marginStart:'5%',fontSize:16,color:Colors.textcolor}}>My Orders</Text>
            </View>
            {/* <TouchableWithoutFeedback onPress={()=>{
...
export default FOrderHistoryScreen