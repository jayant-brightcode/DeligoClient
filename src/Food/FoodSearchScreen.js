...
const renderProducts = ({item})=>{
 ...
 <Image style={{width:'4%',height:18,tintColor:Colors.red,marginStart:'3%'}}  source={require('../../assets/search.png')}/>
       ...
       <TextInput style={{marginStart:'3%',fontFamily:'urbanistregular'}} placeholder="Search items">Biryani</TextInput>
        ...
        <View style={{ flexDirection: 'row', width: '94%', alignSelf: 'center', marginTop: '3%' }}>
      <TouchableOpacity
        style={{
          width: '50%',
          borderBottomWidth: selectedOption === 'Restaurants' ? 4 : 3,
          borderBottomColor: selectedOption === 'Restaurants' ? 'red' : 'gray',
          padding: 7,
        }}
        onPress={() => setSelectedOption('Restaurants')}
      >
        <Text style={{ alignSelf: 'center', fontFamily: 'urbanistextrabold', fontSize: 18 }}>Restaurants</Text>
      </TouchableOpacity>

      <TouchableOpacity
        style={{
          width: '50%',
          borderBottomWidth: selectedOption === 'Dishes' ? 4 : 3,
          borderBottomColor: selectedOption === 'Dishes' ? 'red' : 'gray',
          padding: 7,
        }}
        onPress={() => setSelectedOption('Dishes')}
      >
        <Text style={{ alignSelf: 'center', fontFamily: 'urbanistextrabold', fontSize: 18 }}>Dishes</Text>
      </TouchableOpacity>
    </View>
