  ...
  return(
    ...
    return <View style={style.container}>
        ...
        <View style={{flexDirection:'row',alignItems:'center',backgroundColor:Colors.altra_light_purple,marginTop:'2%',alignContent:'center',justifyContent:'space-between'}}>
         ...
         <Image style={{width:12,height:18,marginStart:'4%',marginEnd:'4',marginEnd:'4%',tintColor:Colors.textcolor}}  source={require('../../assets/location_white.png')}/>
        ...
        <View style={{marginStart:10,marginEnd:10,marginTop:'5%'}}>
          ...
          <TextInput style={{borderBottomColor:Colors.green,borderBottomWidth:1,marginTop:13}} aria-label="House" placeholder="Landmark" />
           ...
           <TouchableWithoutFeedback onPress={()=>{
              ...
              <Text numColumns={2} style={{position:'absolute',alignSelf:'center',bottom:'5%',color:Colors.white,fontFamily:'urbanistmedium',fontSize:14,width:'90%',textAlign:'center',marginStart:3,backgroundColor:Colors.red,padding:10,marginEnd:'3%',borderRadius:10}}>Place Order</Text>
...
export default FoodAddaddressScreen